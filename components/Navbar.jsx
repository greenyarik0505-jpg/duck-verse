          ...
          <div className="mobile-drawer-content">
            ...
            >
              ...
              <div className="mobile-nav-text">
                <span className="mobile-nav-title">Тема оформлення</span>
                <span className="mobile-nav-desc">Персоналізація стилю хабу</span>
              </div>
            </button>
            ...
            >
              <span className="mobile-nav-icon">👤</span>
              <div className="mobile-nav-text">
                <span className="mobile-nav-title">Профіль гравця</span>
                <span className="mobile-nav-desc">Статистика та аватар</span>
              </div>
            </button>
            ...
            >
              <span className="mobile-nav-icon">🏅</span>
              <div className="mobile-nav-text">
                <span className="mobile-nav-title">Досягнення</span>
                <span className="mobile-nav-desc">Квести та нагороди</span>
              </div>
            </button>
            ...
            {isAcademyEnabled() && (
              ...
              >
                <span className="mobile-nav-icon">🎓</span>
                <div className="mobile-nav-text">
                  <span className="mobile-nav-title">Duck Academy</span>
                  <span className="mobile-nav-desc">Навчальні рівні L0-L9</span>
                </div>
              </Link>
            )}
