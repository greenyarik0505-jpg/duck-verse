...
function initializeSeedUsers() {
  ...
  // 3. Адміністратори (Admins)
  // 3.1 Головний системний адмін (Root Admin)
  ...
  // 3.2 Адміністратор — Ярик (Team Lead)
  const yarikSalt = crypto.randomBytes(16).toString('hex');
  usersDb.set('user_admin_yarik', {
    id: 'user_admin_yarik',
    username: 'Yarik0505',
    salt: yarikSalt,
    passwordHash: hashPassword('YarikPass2026!', yarikSalt),
    role: ACADEMY_ROLES.ADMIN,
    parentConsent: null,
    createdAt: '2026-09-17T12:00:00.000Z',
  });
  usersDb.set('user_admin_yarik_alias', {
    id: 'user_admin_yarik_alias',
  ...
  // 3.3 Адміністратор — Діма (Степаненко Дмитро)
  const dimaSalt = crypto.randomBytes(16).toString('hex');
  usersDb.set('user_admin_dima', {
    id: 'user_admin_dima',
    username: 'admin_dima',
    salt: dimaSalt,
    passwordHash: hashPassword('DimaPass2026!', dimaSalt),
    role: ACADEMY_ROLES.ADMIN,
    parentConsent: null,
    createdAt: '2026-09-17T12:00:00.000Z',
  });
  usersDb.set('user_admin_dima_alias', {
    id: 'user_admin_dima_alias',
    username: 'dima_stepanenko',
    salt: dimaSalt,
    passwordHash: hashPassword('DimaPass2026!', dimaSalt),
    role: ACADEMY_ROLES.ADMIN,
    parentConsent: null,
  ...
  // 3.4 Адміністратор — Кирил (Кирил Пушкарук)
  const kirillSalt = crypto.randomBytes(16).toString('hex');
  usersDb.set('user_admin_kirill', {
    id: 'user_admin_kirill',
    username: 'admin_kirill',
    salt: kirillSalt,
    passwordHash: hashPassword('KirillPass2026!', kirillSalt),
    role: ACADEMY_ROLES.ADMIN,
    parentConsent: null,
    createdAt: '2026-09-17T12:00:00.000Z',
  });
  usersDb.set('user_admin_kirill_alias', {
    id: 'user_admin_kirill_alias',
    username: 'kirill_pushkaruk',
    salt: kirillSalt,
    passwordHash: hashPassword('KirillPass2026!', kirillSalt),
    role: ACADEMY_ROLES.ADMIN,
    parentConsent: null,
